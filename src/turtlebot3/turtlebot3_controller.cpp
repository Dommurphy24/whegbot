...
bool Turtlebot3Controller::init(float max_lin_vel, float max_ang_vel, uint8_t scale_lin_vel, uint8_t scale_ang_vel, bool toggle_wheg, uint32_t clock_val)
{
  ...
  toggle_wheg_ = toggle_wheg;
  clock_val_ = clock_val;
...
// bool Turtlebot3Controller::getRCdataWheg()
// {
//   uint16_t received_data = 0;
//   if (rc100_.available())
//   {
//     received_data = rc100_.readData();
//     if (received_data & RC100_BTN_3)
//     {
//       if (millis() - clock_val_ >= interval)
//       {
//         toggle_wheg_ = !toggle_wheg_;
//       }
//     clock_val_ = millis();
//   // Serial.println(toggle_wheg_);
//     }
//   }
//   return toggle_wheg_;
//  }
